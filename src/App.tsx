  ...
  return (
    <div className="container" >
      ...
      <main>
        ...
        <span>{location ? location : "San Francisco"}</span>
        </div>
        <div className="url">
        ...
        <span><a href={url}>{blog ? blog : "https://github.blog"}</a></span>
        </div>
       ...
       <span id="blur">{twitter_username ? twitter_username : "Not Available"}</span>
        </div>
        <div className="platform">
        <img src={building} alt="" />
        <span>{company ? company : "@github"}</span>
        </div>
        </div>
        </div>
